...
organizations = [
    Organization.create!(
        name: 'Club Alpin Français - Grenoble',
        subdomain: 'caf-grenoble'
    ),
    Organization.create!(
        name: 'Club Montagne Lyon',
        subdomain: 'montagne-lyon'
    )
]

organizations.each do |organization|
    ActsAsTenant.with_tenant(organization) do
        puts "Creating profiles for #{organization.name}..."
